...
#define MOS_TEMP_OVER_RES            		1.0  	/* NTC resistance value during MOS over temperature, corresponding to 1.0 at 95 ¡æ, voltage 0.45V */ 
...
/* ---------------------------- VSP Speed command Parameter 0~5V¶ÔÓ¦ADÖµ0~1800 -------------------------- */
